...
// Import logo images
import anotherPaneerLogo from '../assets/logos/another_paneer.png';
import panfishLogo from '../assets/logos/panfish.png';
import cheerLogo from '../assets/logos/cheer.png';
import restaurantLogo from '../assets/logos/restaurant.png';
import rostreLogo from '../assets/logos/rostre.png';
import rithikaLogo from '../assets/logos/rithika.png';
...
const GoogleAdsIcon = () => (
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 14" fill="none" className={styles.footerIconImg}>
...
const MetaIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 21 14" fill="none" className={styles.footerIconImg}>
...
const SocialConnect = () => {
  // Top row logos (High shallow arc)
  // Top row logos (High shallow arc)
  const baseTopLogos = [
    { id: 't1', name: 'Alley 91', logo: null, placeholder: 'Alley 91' },
    { id: 't2', name: 'Andhra Canteen', logo: null, placeholder: 'Andhra Canteen' },
    { id: 't3', name: 'Panfish', logo: panfishLogo },
    { id: 't4', name: 'Summer Green', logo: null, placeholder: 'Summer Green' },
    { id: 't5', name: 'Dosth Band', logo: null, placeholder: 'Dosth Band' },
    { id: 't6', name: 'Cheer', logo: cheerLogo },
    { id: 't7', name: 'Restaurant', logo: restaurantLogo },
  ];

  // Duplicate for density (10 items total for balanced spacing)
  const topLogos = [...baseTopLogos, ...baseTopLogos.slice(0, 3)];

  // Bottom row logos (Lower deep arc)
  const baseBottomLogos = [
    { id: 'b1', name: 'Rostre', logo: rostreLogo },
    { id: 'b2', name: 'Rithika', logo: rithikaLogo },
    { id: 'b3', name: 'Deccan Spice', logo: null, placeholder: 'Deccan Spice' },
    { id: 'b4', name: 'Another Paneer', logo: anotherPaneerLogo },
    { id: 'b5', name: 'Aasam Spice', logo: null, placeholder: 'Aasam Spice' },
  ];

  // Duplicate for density (10 items total for balanced spacing)
  const bottomLogos = [...baseBottomLogos, ...baseBottomLogos];
      ...
      <footer className={styles.footer}>
        ...
        <div className={styles.footerLine}>
          ...
          <div className={styles.footerIcons}>
            <div className={styles.socialIcon} title="Instagram"><InstagramIcon /></div>
            <div className={styles.socialIcon} title="Facebook"><FacebookIcon /></div>
          </div>
        </div>

        {/* Line 2: Promotional Tools */}
        <div className={styles.footerLine}>
          <span className={styles.footerText}>& promote you using</span>
          <div className={styles.footerIcons}>
            <div className={styles.toolIcon} title="Google Ads"><GoogleAdsIcon /></div>
            <div className={styles.toolIcon} title="Meta"><MetaIcon /></div>
            <div className={styles.toolIcon} title="Email Marketing">
